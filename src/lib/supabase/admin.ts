...
export const defaultHero: HeroSettings = {
  ...
  name: 'Suvash Mukhiya',
  tagline: 'Website design & App Development',
  experiences: '1+',
  projects_done: '5+',
  rating: '1+',
  cv_link: '',
...
export const defaultAbout: AboutSettings = {
  ...
  subtitle: 'My journey in the world of code and design.',
  bio: 'With a passion for building beautiful and functional web and mobile applications, I turn complex problems into elegant digital solutions. My expertise lies in full-stack development, creating seamless experiences from server to screen.',
  photo: '/profile.png',
