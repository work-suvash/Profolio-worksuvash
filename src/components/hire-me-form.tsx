...
export function HireMeForm({ open, onOpenChange }: HireMeFormProps) {
  ...
  function onSubmit(values: HireMeFormValues) {
    const subject = encodeURIComponent(`Project Inquiry: ${values.projectTitle}`);
    ...
    const mailtoLink = `mailto:worksuvash@gmail.com?subject=${subject}&body=${body}`;
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 pb-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
               ...
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-semibold ml-1">Project / Job Title</FormLabel>
                    <FormControl>
                      <Input placeholder="e.g., New E-commerce Website" {...field} className="h-12 rounded-[16px] bg-secondary/30 border-primary/10 focus:border-primary/40 focus:ring-1 focus:ring-primary/40 transition-all" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., $5,000 - $10,000" {...field} className="h-12 rounded-[16px] bg-secondary/30 border-primary/10 focus:border-primary/40 focus:ring-1 focus:ring-primary/40 transition-all" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., 3-4 Weeks" {...field} className="h-12 rounded-[16px] bg-secondary/30 border-primary/10 focus:border-primary/40 focus:ring-1 focus:ring-primary/40 transition-all" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
