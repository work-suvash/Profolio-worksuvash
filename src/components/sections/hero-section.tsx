...
import { getSetting, defaultHero, type HeroSettings } from '@/lib/supabase/admin';
...
export default function HeroSection() {
  ...
  const stats = [
    ...
    { value: hero.projects_done, label: 'Project done' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
          <div className="flex items-center justify-center order-1 md:order-2">
            ...
            >
              ...
              <Image
                src={hero.profile_pic || '/profile.png'}
                alt={`${hero.name} - Professional Web and App Developer`}
                fill
          ...
          <div className="space-y-4 order-2 md:order-1 text-center md:text-left">
            ...
            <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
              <span className="relative inline-block">
                ...
                <span className="relative text-primary">{hero.tagline.split('&')[0]?.trim() || 'Website design'}</span>
              </span>
              <br />
              <span className="whitespace-nowrap">{hero.tagline.split('&')[1]?.trim() || 'App Development'}</span>
            </h1>
