...
const heroProfileImage = PlaceHolderImages.find(p => p.id === 'hero-profile');
...
const stats = [
    ...
    { value: '1+', label: 'Rating by clients' },
];
    ...
    <section id="home" className="container mx-auto py-12 md:py-20 px-4 md:px-6 flex items-center pt-32">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
          ...
          {heroProfileImage && (
            ...
            >
              ...
              <Image
                ...
                alt="Suvash Mukhiya - Professional Web and App Developer Profile Photo"
        ...
        <div className="space-y-4 order-2 md:order-1 text-center md:text-left">
          <p className="text-2xl text-muted-foreground">Hi I am <br /> Suvash Mukhiya</p>
          <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
            <span className="relative inline-block">
              ...
              <span className="relative text-primary">Website design</span>
            </span><br /><span className="whitespace-nowrap">App Development</span>
          </h1>
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <button className="gradient-btn w-full sm:w-auto min-h-[48px] rounded-full shrink-0">
          ...
          <div className="flex items-center gap-4 pt-4 justify-center md:justify-start">
            {socialLinks.map(({ Icon, href }, index) => (
              <a key={index} href={href} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
