        ...
        <section id="projects" className="py-12 bg-card">
          <div className="container mx-auto px-4 md:px-6">
              <div className="text-center space-y-4 mb-8">
                  <h2 className="text-4xl font-headline font-bold text-primary tracking-tight">Projects</h2>
              </div>
    ...
    <>
      <section id="projects" className="py-12 bg-card overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <nav className="flex justify-center flex-wrap gap-3 mb-8" aria-label="Project filters">
            {filters.map(filter => (
              <button
                key={filter}
