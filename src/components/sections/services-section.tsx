...
const DEFAULT_SERVICES = [
  { id: 'd1', icon_name: 'Palette', title: 'App Design', description: 'Crafting intuitive and visually stunning user interfaces that enhance user experience and engagement across all platforms.', thumbnail: '', link: '', sort_order: 0 },
  { id: 'd2', icon_name: 'Code', title: 'Web Development', description: 'Building robust, scalable, and high-performance websites and web applications with modern technologies.', thumbnail: '', link: '', sort_order: 1 },
  { id: 'd3', icon_name: 'Smartphone', title: 'Mobile Apps', description: 'Developing native and cross-platform mobile applications for iOS and Android to bring your ideas to life.', thumbnail: '', link: '', sort_order: 2 },
];
