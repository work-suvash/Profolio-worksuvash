...
export default function DashboardTab() {
  ...
  const statCards = [
    ...
    { label: 'Projects', value: stats.projects, icon: FolderOpen, color: 'text-orange-400', bg: 'bg-orange-500/10' },
    { label: 'Services', value: stats.services, icon: Layers, color: 'text-purple-400', bg: 'bg-purple-500/10' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card border border-border/40 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Top Projects</h3>
          </div>
