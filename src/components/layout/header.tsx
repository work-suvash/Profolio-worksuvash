  ...
  return (
    ...
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        <Link href="#home" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-red-500 drop-shadow-[0_0_8px_hsl(var(--primary))]">
          WS
        </Link>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <div className="flex h-full flex-col p-6">
                  <div className="mb-8 flex items-center justify-between">
                     <Link href="#home" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-red-500" onClick={() => setIsMobileMenuOpen(false)}>
                      WS
                    </Link>
                    <SheetTrigger asChild>
                       <Button variant="ghost" size="icon">
