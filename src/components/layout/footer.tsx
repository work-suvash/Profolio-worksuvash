      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center justify-between py-4 gap-4">
          ...
          <div className="flex-shrink-0 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-primary via-purple-500 to-red-500 rounded-full blur-xl opacity-40"></div>
            <Link href="#home" className="relative text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-red-500">
              WS
            </Link>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-3 py-3">
          <a href="mailto:worksuvash@gmail.com" className="flex items-center gap-1 text-muted-foreground hover:text-primary transition-colors text-xs">
            <Mail className="h-4 w-4" />
            worksuvash@gmail.com
          </a>
          <a href="tel:+9779812345678" className="flex items-center gap-1 text-muted-foreground hover:text-primary transition-colors text-xs">
        ...
        <div className="text-center text-xs text-muted-foreground py-2 border-t border-border/30">
          <p>&copy; {new Date().getFullYear()} PortfolioPro. All rights reserved by Suvash Mukhiya.</p>
        </div>
      </div>
    </footer>
  );
