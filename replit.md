# Suvash Mukhiya Portfolio

A Next.js 15 personal portfolio website with a fully-featured hidden admin panel.
...
- `src/components/` — UI components
  - `sections/` — Portfolio sections (Hero, Services, About, Projects, Contact)
